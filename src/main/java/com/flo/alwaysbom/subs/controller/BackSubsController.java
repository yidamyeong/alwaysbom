...
public class BackSubsController {
    ...
    public String addSubs(SubsVo svo, List<MultipartFile> file) throws IOException {
        ...
        return "redirect:/admin/subs/list";
    }
